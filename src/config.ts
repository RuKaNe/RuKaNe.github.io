...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/beijing.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	links: [
		{
			...
			url: "https://x.com/Ace_RuKaNe",
		},
		{
			name: "bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/455680570",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/RuKaNe",
		},
	],
};
